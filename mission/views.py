...
class MissionListView(ListView):
	...
	def get_context_data(self, *args, **kwargs):
	    ...
	    exclude_fields=["id","verified", "pickable"], exclude_filter_fields=["id", "verified", "pickable"])
...
class ScanMissionTemplateView(UpdateView):
	...
	def get_context_data(self, *args, **kwargs):
		...
		if product_missions.count() > 0:
		    ...
		    exclude_fields=["id", "mission"], exclude_filter_fields=["id", "mission"], template_tagname="product_mission_field_names",\
		    				allow_related=True)
		else:
