...
from .views import OrderListView, OrderListAPIView, OrderDetailView, OrderCreateView, OrderUpdateView, \
    ScanOrderTemplateView,search_positions,PositionProductOrderListAPIView,search_after_product_on_we
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/api/productorderposition/$', PositionProductOrderListAPIView.as_view(), name="apilistforProduct"),
